...
var desc = 'Zip tests files according to configurations';
exports.desc = desc;

var builder = _objectSpread(_objectSpread({}, _optionsBuilder.testsOptions), {}, {
  out: {
    describe: 'Output path for zip file',
    default: _defaults.DEFAULT_ARCHIVE_PATH
  }
...
var handler = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(function* (argv) {
    ...
    yield (0, _pack.default)(configObject.tests.path, configObject.tests.ignore, argv.out);
  });
